...
As well as overloading default STRUCT methods (such as `model_apply`, `model.train`, `model.precict` etc) it is also helpful to overload the extend the default `show` method to make the displayed output more informative for the new object. This is described in the following sections.
